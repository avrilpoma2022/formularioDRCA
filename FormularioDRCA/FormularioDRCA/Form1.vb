Public Class Form1
    ...
    Private Sub CheckBox1_CheckedChanged(sender As Object, e As EventArgs) Handles checkanual.CheckedChanged
    ...
    Private Sub CheckBox1_CheckedChanged_1(sender As Object, e As EventArgs) Handles checkdiario.CheckedChanged
